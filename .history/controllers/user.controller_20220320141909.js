...
module.exports = {
    ...
    addUser: async function (req, res) {
        ...
        try {
            ...
            const [_statsus, userExists] = await this.checkUsernameExists(req.body.username)

            if (userExists) return res.json({ status: userExists, error: "Username already exists" })
